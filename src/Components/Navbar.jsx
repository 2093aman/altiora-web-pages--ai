      ...
      >
        ...
        <div className="container" style={{ maxWidth: 1120 }}>
          <div className="d-flex align-items-center justify-content-between gap-2" style={{ height: 61 }}>
            {/* Brand — now a normal external link */}
            <a
              href="https://www.altiorainfotech.com"
              aria-label="Altiora Infotech (main site)"
              className="d-inline-flex align-items-center rounded"
              // For new tab instead: add target="_blank" rel="noopener noreferrer"
            ...
            >
              {logoOk ? (
                ...
                <span
                  ...
                  style={{ width: 56, height: 56, placeItems: 'center', background: '#fff', fontSize: 16 }}
                >
                  ●
                </span>
              )}
