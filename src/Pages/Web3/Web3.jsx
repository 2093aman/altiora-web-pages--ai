...
import calenderly1 from '../../assets/calenderly1.png';
import TechnologyStackSection from '../TechnologyStack/TechnologyStackSection';

const Web3Page = () => {
  // Load Calendly script once
  useEffect(() => {
    const id = 'calendly-inline-widget-script';
                  ...
                  <div className="process-item d-flex align-items-start mb-4">
                    <div className="process-number me-3">
                      <div
                        ...
                        style={{ width: 50, height: 50, backgroundColor: '#ffc107', fontSize: '1.2rem', fontWeight: 'bold', color: '#000' }}
                      >
                        01
                      </div>
                    </div>
...
<section className="py-5" style={{ backgroundColor: '#1a1a3a' }}>
  <div className="container">
    <div className="text-center">
      <h2 className="display-6 fw-bold mb-3 mb-md-4">
        Ready to Build Your Web3 Solution?
      </h2>
      <p className="lead mb-4" style={{ color: '#cccccc' }}>
        Join the decentralized revolution with our expert blockchain development team.
      </p>

      {/* Use grid so buttons stack on xs and sit inline on sm+ */}
      <div className="row g-2 g-sm-3 justify-content-center">
        <div className="col-12 col-sm-auto">
          <button
            type="button"
            className="btn btn-primary btn-lg px-5 disabled btn-block-sm"
            disabled
            aria-disabled="true"
          >
            Start Your Project
        ...
        <div className="col-12 col-sm-auto">
          <a
            href="https://www.altiorainfotech.com/contact"
            className="btn btn-outline-light btn-lg px-5 btn-block-sm"
  ...
  <style jsx>{`
  /* Subtle shadow class reused on the illustration */
  .shadow-illu { filter: drop-shadow(0 20px 40px rgba(0,0,0,0.35)); }

  /* Make CTAs full-width on phones, auto on larger screens */
  .btn-block-sm { width: 100%; }

  /* Even spacing between stacked buttons on mobile */
  @media (max-width: 575.98px) {
    .btn-block-sm + .btn-block-sm { margin-top: 0.5rem; }
  }

  /* Calendly card: ensure nice alignment and prevent overflow on small screens */
  .calendly-card { overflow: hidden; }

  /* Responsive Calendly height:
     - a bit shorter on phones
     - medium on tablets
     - full planned height on desktops */
  @media (max-width: 575.98px) {
    .calendly-inline-widget { height: 520px !important; min-width: 100% !important; }
  }
  ...
  /* Tidy up vertical rhythm on the bottom section for small screens */
  @media (max-width: 575.98px) {
